<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <!-- 搜索 start -->
      <el-form :model="listQuery" ref="queryForm" :inline="true" label-width="40px">
        ...
        <el-form-item>
          ...
          <el-button type="primary" size="mini" plain @click="showForm('出厂确认')">出厂确认</el-button>
    ...
    >
      ...
      <el-table-column align="center" prop="ccsj" label="出厂时间" />
      <el-table-column align="center" :label="'操作'" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-link type="primary" @click="showForm(scope.row)">修改出厂时间</el-link>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="'修改时间登记'" width="99%" :visible.sync="dialogFormVisible">
      <el-form
        :rules="rules"
        ref="dataForm"
        :model="temp"
...
import { getRecordByTrackId, completeSample } from "@/api/api";
