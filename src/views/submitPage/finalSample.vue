<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="main_content">
      ...
      >
        <template slot="extra">
          <el-button type="primary" size="small">采样完成</el-button>
        </template>
        <el-descriptions-item label="股道">{{item.gd}}</el-descriptions-item>
        <el-descriptions-item label="物资">{{item.wz}}</el-descriptions-item>
        <el-descriptions-item label="取样完成时间">{{item.timestamp}}</el-descriptions-item>
      </el-descriptions>
