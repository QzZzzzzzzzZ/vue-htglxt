<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-form :model="listQuery" ref="queryForm" :inline="true" label-width="40px">
        ...
        <el-form-item>
          ...
          <el-button type="primary" size="mini" plain @click="showForm('报空登记')">报空登记</el-button>
    ...
    <el-dialog :title="'报空时间登记'" width="99%" :visible.sync="dialogFormVisible">
      <el-form
        :rules="rules"
        ref="dataForm"
        :model="temp"
...
import { getRecordByTrackId, completeEmpty } from "@/api/api";
